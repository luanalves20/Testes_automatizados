...
public class LocacaoInternacional {
	...
	@Test
	public void locacaoInternacional() throws InterruptedException {
		...
		try {
			gravaArquivosLog.GravaLocacaoInternacional(elementos.getNumeroReserva());
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
