...
public class LocacaoHoraExcedente {
	...
	@Test
	public void locacaoHoraExcedente() {
		...
		Select dropDownHoraExcedente = new Select(driver.findElement(By.id("HoraDevolucao")));
		dropDownHoraExcedente.selectByVisibleText("17:00");
		...
		try {
			gravaArquivosLog.GravaLocacaoHoraExcedente(elementos.getNumeroReserva());
		} catch (IOException e) {
			e.printStackTrace();
		}
